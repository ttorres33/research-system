...
# Update Research Filters Command

Help you refine filter criteria through an interactive interview about what papers are irrelevant.
...
If "Yes":
- Invoke the filter-research-digest command with the same digest date
...
- This command modifies config.yaml in place
